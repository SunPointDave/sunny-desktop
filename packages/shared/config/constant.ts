...
export enum FeedUrl {
  PRODUCTION = 'https://sunpointit.com/releases',
  GITHUB_LATEST = 'https://sunpointit.com/releases/latest/download'
}

export enum UpdateConfigUrl {
  GITHUB = 'https://sunpointit.com/app-upgrade-config.json',
  GITCODE = 'https://sunpointit.com/app-upgrade-config.json'
}
...
export const HOME_CHERRY_DIR = '.sunny'
